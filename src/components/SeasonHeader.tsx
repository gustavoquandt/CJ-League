        ...
        <div className="flex items-stretch gap-3 pb-3">
          ...
          <div className="flex items-center gap-4 px-3 py-2 rounded-lg bg-[rgba(26,31,110,0.2)] border border-[rgba(37,43,138,0.35)]">
            <div className="flex items-center gap-1.5">
              <svg className="w-3.5 h-3.5 text-[#e31e24] flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          {onRefreshData && (
            <button
              ...
              className="flex items-center gap-2 px-4 py-2 bg-[#e31e24] hover:bg-[#b51419]
